    ...
    flake-utils.lib.eachSystem [
      ...
      let
        ...
        toshy = python.pkgs.buildPythonApplication rec {
          ...
          # Updated dependencies based on updated_requirements.txt
          propagatedBuildInputs = with python.pkgs; [
            # Core dependencies
            dbus-python
            pillow
      ...
      in {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo ""
            echo "CLI Commands:"
            echo "  - toshy-tray: Launch the system tray application"
            echo "  - toshy-gui: Launch the GUI preferences application"
            echo "  - toshy-layout-selector: Launch the keyboard layout selector"
            echo "  - toshy-config: Configure Toshy"
            echo "  - toshy-daemon: Run the Toshy daemon"
